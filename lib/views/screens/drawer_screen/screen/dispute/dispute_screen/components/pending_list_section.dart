...
import 'package:lekra/views/screens/drawer_screen/screen/dispute/dispute_details/dispute_detail_screen.dart';
import 'package:lekra/views/screens/drawer_screen/screen/dispute/dispute_screen/components/dispute_container.dart';

class PendingListSection extends StatelessWidget {
  final ScrollController controller;
  const PendingListSection({super.key, required this.controller});
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              ...
              navigate(context: context, page: DisputeDetailsScreen());
            },
            child: CustomShimmer(
